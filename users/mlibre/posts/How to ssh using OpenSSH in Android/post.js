...
{
	"type": "video",
	"title": "How to ssh using OpenSSH in Android",
	"address": "video.mp4",
	"cover": "android.jpg",
	"body": "How to ssh to your server from Android terminal without any special app.\n\tCommands:\n\tapt update\n\tapt install openssh\n\tssh mlibre@192.168.1.1\n\t",
	"refrences": [
	...
	"filename": "post.js",
	"folderPath": "users/mlibre/posts/How to ssh using OpenSSH in Android/"
}